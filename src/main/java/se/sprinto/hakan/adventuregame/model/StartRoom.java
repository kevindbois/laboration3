...
public class StartRoom implements Room {
    ...
    public void enterRoom(Player player, UI ui) {
        ...
        boolean exit = false;
        while (!exit) {
            String choice = ui.getInput("Vilken dörr vill du ta? (1=Skog, 2=Fängelse, 3=Skattkammare, 4=Kyrkgård, 5=Kloaken, q=avsluta)");
            switch (choice) {
                case "1":
                ...
                case "3":
                    ...
                    break;
                case "4":
                    new CemetaryRoom().enterRoom(player, ui);
                    break;
                case "5":
                    new SewerRoom().enterRoom(player, ui);
                    break;
                case "q":
                    exit = true;
                    break;
